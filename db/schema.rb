...
ActiveRecord::Schema.define(version: 20140323221509) do
  ...
  create_table "stories", force: true do |t|
    ...
    t.text     "description"
    t.string   "short_id",               limit: 6,                                           null: false
    t.integer  "is_expired",                                                   default: 0,   null: false
    t.integer  "upvotes",                                                      default: 0,   null: false
    t.integer  "downvotes",                                                    default: 0,   null: false
    t.integer  "is_moderated",                                                 default: 0,   null: false
  ...
  add_index "tags", ["important"], name: "index_tags_on_important", using: :btree
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "session_token",        limit: 75,                  null: false
    t.text     "about"
